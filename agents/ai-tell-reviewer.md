...
2. Ground every judgment in the rubric at `$CLAUDE_PLUGIN_ROOT/ai-writing-guide.md` — the vocabulary fingerprint, statistical signatures (perplexity/burstiness proxies), and content-level tells (superficial profundity, absence of voice, ghost citations, formulaic structure) documented there.
